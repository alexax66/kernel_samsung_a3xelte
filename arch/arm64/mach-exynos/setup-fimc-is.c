...
int exynos7580_fimc_is_clk_gate(u32 clk_gate_id, bool is_on)
{
	/*TODO*/
...
int exynos7580_fimc_is_cfg_clk(struct platform_device *pdev)
{
	pr_debug("%s\n", __func__);

	/* SCLK MAX DIV */
	fimc_is_set_parent_dt(pdev, "mout_sclk_isp_spi0_ext_clk", "oscclk");
	fimc_is_set_parent_dt(pdev, "mout_sclk_isp_spi1_ext_clk", "oscclk");
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_a", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_b", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_a", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_b", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_uart_ext_uclk", 1);

	/* ISP MAX DIV */
	fimc_is_set_rate_dt(pdev, "dout_isp_pll_div2", 1);
	fimc_is_set_rate_dt(pdev, "dout_isp_pll_div3", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_clkin", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_atclkin", 1);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_pclkdbg", 1);
	fimc_is_set_rate_dt(pdev, "dout_pclk_csi_link0_225", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_link_data", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_csi_link1_75", 1);
	fimc_is_set_rate_dt(pdev, "dout_pclk_csi_link1_37", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_fimc_isp_450", 1);
	fimc_is_set_rate_dt(pdev, "dout_pclk_fimc_isp_225", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_fimc_fd_300", 1);
	fimc_is_set_rate_dt(pdev, "dout_pclk_fimc_fd_150", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_266", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_133", 1);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_67", 1);

	/* USER MUX */
	fimc_is_set_rate_dt(pdev, "isp_pll", 1060 * 1000000);
	fimc_is_get_rate_dt(pdev, "isp_pll");
	fimc_is_enable_dt(pdev, "isp_pll");
	fimc_is_enable_dt(pdev, "mout_sclk_spi0_isp_ext_clk_user");
	fimc_is_enable_dt(pdev, "mout_sclk_spi1_isp_ext_clk_user");
	fimc_is_enable_dt(pdev, "mout_aclk_isp_400_user");
	fimc_is_enable_dt(pdev, "mout_aclk_isp_333_user");
	fimc_is_enable_dt(pdev, "mout_aclk_isp_266_user");

	return 0;
}

int exynos7580_fimc_is_clk_on(struct platform_device *pdev)
{
	int ret = 0;
	struct exynos_platform_fimc_is *pdata;
	...
	/* ISP */
	fimc_is_set_parent_dt(pdev, "mout_sclk_cpu_isp_clkin_a", "dout_isp_pll_div2");
	fimc_is_set_parent_dt(pdev, "mout_sclk_cpu_isp_clkin_b", "mout_sclk_cpu_isp_clkin_a");
	fimc_is_set_parent_dt(pdev, "mout_aclk_link_data_a", "mout_aclk_isp_400_user");
	fimc_is_set_parent_dt(pdev, "mout_aclk_link_data_b", "mout_aclk_link_data_a");
	fimc_is_set_parent_dt(pdev, "mout_aclk_link_data_c", "mout_aclk_link_data_b");
	fimc_is_set_parent_dt(pdev, "mout_aclk_csi_link1_75", "dout_isp_pll_div3");
	fimc_is_set_parent_dt(pdev, "mout_aclk_csi_link1_75_b", "mout_aclk_isp_400_user");
	fimc_is_set_parent_dt(pdev, "mout_aclk_fimc_isp_450_a", "dout_isp_pll_div2");
	fimc_is_set_parent_dt(pdev, "mout_aclk_fimc_isp_450_b", "mout_aclk_fimc_isp_450_a");
	fimc_is_set_parent_dt(pdev, "mout_aclk_fimc_isp_450_c", "mout_aclk_fimc_isp_450_b");
	fimc_is_set_parent_dt(pdev, "mout_aclk_fimc_isp_450_d", "mout_aclk_fimc_isp_450_c");
	fimc_is_set_parent_dt(pdev, "mout_aclk_fimc_fd_300", "dout_isp_pll_div3");

	fimc_is_set_rate_dt(pdev, "dout_isp_pll_div2", 530 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_isp_pll_div3", 530 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_clkin", 530 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_atclkin", 266* 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_cpu_isp_pclkdbg", 67 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_pclk_csi_link0_225", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_link_data", 400 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_csi_link1_75", 200 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_pclk_csi_link1_37", 100 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_fimc_isp_450", 530 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_pclk_fimc_isp_225", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_fimc_fd_300", 530 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_pclk_fimc_fd_150", 266 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_266", 267 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_133", 134 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_aclk_isp_67", 67 * 1000000);

	/* SCLK */
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_a", 26 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_b", 10 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_a", 26 * 1000000);
	fimc_is_set_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_b", 10 * 1000000);

	/* DEBUG */
	fimc_is_get_rate_dt(pdev, "dout_isp_pll_div2");
	fimc_is_get_rate_dt(pdev, "dout_isp_pll_div3");
	fimc_is_get_rate_dt(pdev, "dout_sclk_cpu_isp_clkin");
	fimc_is_get_rate_dt(pdev, "dout_sclk_cpu_isp_atclkin");
	fimc_is_get_rate_dt(pdev, "dout_sclk_cpu_isp_pclkdbg");
	fimc_is_get_rate_dt(pdev, "dout_pclk_csi_link0_225");
	fimc_is_get_rate_dt(pdev, "dout_aclk_link_data");
	fimc_is_get_rate_dt(pdev, "dout_aclk_csi_link1_75");
	fimc_is_get_rate_dt(pdev, "dout_pclk_csi_link1_37");
	fimc_is_get_rate_dt(pdev, "dout_aclk_fimc_isp_450");
	fimc_is_get_rate_dt(pdev, "dout_pclk_fimc_isp_225");
	fimc_is_get_rate_dt(pdev, "dout_aclk_fimc_fd_300");
	fimc_is_get_rate_dt(pdev, "dout_pclk_fimc_fd_150");
	fimc_is_get_rate_dt(pdev, "dout_aclk_isp_266");
	fimc_is_get_rate_dt(pdev, "dout_aclk_isp_133");
	fimc_is_get_rate_dt(pdev, "dout_aclk_isp_67");
	fimc_is_get_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_a");
	fimc_is_get_rate_dt(pdev, "dout_sclk_isp_spi0_ext_clk_b");
	fimc_is_get_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_a");
	fimc_is_get_rate_dt(pdev, "dout_sclk_isp_spi1_ext_clk_b");
	fimc_is_get_rate_dt(pdev, "dout_sclk_isp_uart_ext_uclk");
...
int exynos7580_fimc_is_clk_off(struct platform_device *pdev)
{
	int ret = 0;
	struct exynos_platform_fimc_is *pdata;
	...
	fimc_is_disable_dt(pdev, "mout_sclk_spi0_isp_ext_clk_user");
	fimc_is_disable_dt(pdev, "mout_sclk_spi1_isp_ext_clk_user");
	fimc_is_disable_dt(pdev, "mout_aclk_isp_400_user");
	fimc_is_disable_dt(pdev, "mout_aclk_isp_333_user");
	fimc_is_disable_dt(pdev, "mout_aclk_isp_266_user");
	fimc_is_disable_dt(pdev, "isp_pll");
...
int exynos7580_fimc_is_print_clk(struct platform_device *pdev)
{
	pr_debug("%s\n", __func__);
	...
	printk(KERN_DEBUG "#################### TOP clock ####################\n");
	PRINT_CLK(EXYNOS7580_AUD_PLL_LOCK		, "AUD_PLL_LOCK");
	PRINT_CLK(EXYNOS7580_AUD_PLL_CON0		, "AUD_PLL_CON0");
	PRINT_CLK(EXYNOS7580_AUD_PLL_CON1		, "AUD_PLL_CON1");
	PRINT_CLK(EXYNOS7580_AUD_PLL_CON2		, "AUD_PLL_CON2");
	PRINT_CLK(EXYNOS7580_AUD_PLL_FREQ_DET		, "AUD_PLL_FREQ_DET");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP0		, "MUX_SEL_TOP0");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP1		, "MUX_SEL_TOP1");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP2		, "MUX_SEL_TOP2");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP_FSYS0		, "MUX_SEL_TOP_FSYS0");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP_FSYS1		, "MUX_SEL_TOP_FSYS1");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP_FSYS2		, "MUX_SEL_TOP_FSYS2");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP_PERI		, "MUX_SEL_TOP_PERI");
	PRINT_CLK(EXYNOS7580_MUX_SEL_TOP_ISP		, "MUX_SEL_TOP_ISP");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP0		, "MUX_EN_TOP0");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP1		, "MUX_EN_TOP1");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP2		, "MUX_EN_TOP2");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP_FSYS0		, "MUX_EN_TOP_FSYS0");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP_FSYS1		, "MUX_EN_TOP_FSYS1");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP_FSYS2		, "MUX_EN_TOP_FSYS2");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP_PERI		, "MUX_EN_TOP_PERI");
	PRINT_CLK(EXYNOS7580_MUX_EN_TOP_ISP		, "MUX_EN_TOP_ISP");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP0		, "MUX_STAT_TOP0");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP1		, "MUX_STAT_TOP1");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP2		, "MUX_STAT_TOP2");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP_FSYS0		, "MUX_STAT_TOP_FSYS0");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP_FSYS1		, "MUX_STAT_TOP_FSYS1");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP_FSYS2		, "MUX_STAT_TOP_FSYS2");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP_PERI		, "MUX_STAT_TOP_PERI");
	PRINT_CLK(EXYNOS7580_MUX_STAT_TOP_ISP		, "MUX_STAT_TOP_ISP");
	PRINT_CLK(EXYNOS7580_DIV_TOP0			, "DIV_TOP0");
	PRINT_CLK(EXYNOS7580_DIV_TOP1			, "DIV_TOP1");
	PRINT_CLK(EXYNOS7580_DIV_TOP_FSYS0		, "DIV_TOP_FSYS0");
	PRINT_CLK(EXYNOS7580_DIV_TOP_FSYS1		, "DIV_TOP_FSYS1");
	PRINT_CLK(EXYNOS7580_DIV_TOP_FSYS2		, "DIV_TOP_FSYS2");
	PRINT_CLK(EXYNOS7580_DIV_TOP_PERI0		, "DIV_TOP_PERI0");
	PRINT_CLK(EXYNOS7580_DIV_TOP_PERI1		, "DIV_TOP_PERI1");
	PRINT_CLK(EXYNOS7580_DIV_TOP_PERI2		, "DIV_TOP_PERI2");
	PRINT_CLK(EXYNOS7580_DIV_TOP_PERI3		, "DIV_TOP_PERI3");
	PRINT_CLK(EXYNOS7580_DIV_TOP_ISP0		, "DIV_TOP_ISP0");
	PRINT_CLK(EXYNOS7580_DIV_TOP_ISP1		, "DIV_TOP_ISP1");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP0		, "DIV_STAT_TOP0");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP1		, "DIV_STAT_TOP1");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_FSYS0		, "DIV_STAT_TOP_FSYS0");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_FSYS1		, "DIV_STAT_TOP_FSYS1");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_FSYS2		, "DIV_STAT_TOP_FSYS2");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_PERI0		, "DIV_STAT_TOP_PERI0");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_PERI1		, "DIV_STAT_TOP_PERI1");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_PERI2		, "DIV_STAT_TOP_PERI2");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_PERI3		, "DIV_STAT_TOP_PERI3");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_ISP0		, "DIV_STAT_TOP_ISP0");
	PRINT_CLK(EXYNOS7580_DIV_STAT_TOP_ISP1		, "DIV_STAT_TOP_ISP1");
	PRINT_CLK(EXYNOS7580_EN_ACLK_TOP		, "EN_ACLK_TOP");
	PRINT_CLK(EXYNOS7580_EN_SCLK_TOP_FSYS		, "EN_SCLK_TOP_FSYS");
	PRINT_CLK(EXYNOS7580_EN_SCLK_TOP_PERI		, "EN_SCLK_TOP_PERI");
	PRINT_CLK(EXYNOS7580_EN_SCLK_TOP_ISP		, "EN_SCLK_TOP_ISP");
	PRINT_CLK(EXYNOS7580_CLKOUT_CMU_TOP		, "CLKOUT_CMU_TOP");
	PRINT_CLK(EXYNOS7580_CLKOUT_CMU_TOP_DIV_STAT	, "CLKOUT_CMU_TOP_DIV_STAT");
	PRINT_CLK(EXYNOS7580_EN_PDN_TOP			, "EN_PDN_TOP");

	printk(KERN_DEBUG "#################### ISP clock ####################\n");
	PRINT_CLK(EXYNOS7580_ISP_PLL_LOCK		, "ISP_PLL_LOCK");
	PRINT_CLK(EXYNOS7580_ISP_PLL_CON0		, "ISP_PLL_CON0");
	PRINT_CLK(EXYNOS7580_ISP_PLL_CON1		, "ISP_PLL_CON1");
	PRINT_CLK(EXYNOS7580_ISP_PLL_FREQ_DET		, "ISP_PLL_FREQ_DET	    ");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP0		, "MUX_SEL_ISP0");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP1		, "MUX_SEL_ISP1");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP2		, "MUX_SEL_ISP2");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP3		, "MUX_SEL_ISP3");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP4		, "MUX_SEL_ISP4");
	PRINT_CLK(EXYNOS7580_MUX_SEL_ISP5		, "MUX_SEL_ISP5");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP0		, "MUX_EN_ISP0");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP1		, "MUX_EN_ISP1");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP2		, "MUX_EN_ISP2");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP3		, "MUX_EN_ISP3");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP4		, "MUX_EN_ISP4");
	PRINT_CLK(EXYNOS7580_MUX_EN_ISP5		, "MUX_EN_ISP5");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP0		, "MUX_STAT_ISP0");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP1		, "MUX_STAT_ISP1");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP2		, "MUX_STAT_ISP2");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP3		, "MUX_STAT_ISP3");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP4		, "MUX_STAT_ISP4");
	PRINT_CLK(EXYNOS7580_MUX_STAT_ISP5		, "MUX_STAT_ISP5");
	PRINT_CLK(EXYNOS7580_MUX_IGNORE_ISP2		, "MUX_IGNORE_ISP2");
	PRINT_CLK(EXYNOS7580_DIV_ISP0			, "DIV_ISP0");
	PRINT_CLK(EXYNOS7580_DIV_ISP1			, "DIV_ISP1");
	PRINT_CLK(EXYNOS7580_DIV_ISP2			, "DIV_ISP2");
	PRINT_CLK(EXYNOS7580_DIV_ISP3			, "DIV_ISP3");
	PRINT_CLK(EXYNOS7580_DIV_ISP4			, "DIV_ISP4");
	PRINT_CLK(EXYNOS7580_DIV_ISP5			, "DIV_ISP5");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP0		, "DIV_STAT_ISP0");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP1		, "DIV_STAT_ISP1");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP2		, "DIV_STAT_ISP2");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP3		, "DIV_STAT_ISP3");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP4		, "DIV_STAT_ISP4");
	PRINT_CLK(EXYNOS7580_DIV_STAT_ISP5		, "DIV_STAT_ISP5");
	PRINT_CLK(EXYNOS7580_EN_ACLK_ISP_0		, "EN_ACLK_ISP_0");
	PRINT_CLK(EXYNOS7580_EN_ACLK_ISP_1		, "EN_ACLK_ISP_1");
	PRINT_CLK(EXYNOS7580_EN_ACLK_ISP_2		, "EN_ACLK_ISP_2");
	PRINT_CLK(EXYNOS7580_EN_PCLK_ISP_0		, "EN_PCLK_ISP_0");
	PRINT_CLK(EXYNOS7580_EN_PCLK_ISP_1		, "EN_PCLK_ISP_1");
	PRINT_CLK(EXYNOS7580_EN_SCLK_ISP		, "EN_SCLK_ISP");
	PRINT_CLK(EXYNOS7580_CLKOUT_CMU_ISP		, "CLKOUT_CMU_ISP");
	PRINT_CLK(EXYNOS7580_CLKOUT_CMU_ISP_DIV_STAT	, "CLKOUT_CMU_ISP_DIV_STAT");
...
#elif defined(CONFIG_SOC_EXYNOS7580)
	exynos7580_fimc_is_cfg_clk(pdev);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7580)
	exynos7580_fimc_is_clk_on(pdev);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7580)
	exynos7580_fimc_is_clk_off(pdev);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7580)
	exynos7580_fimc_is_print_clk(pdev);
#endif
	return 0;
}
...
#elif defined(CONFIG_SOC_EXYNOS7580)
	exynos7580_fimc_is_clk_gate(clk_gate_id, is_on);
#endif
	return 0;
}
